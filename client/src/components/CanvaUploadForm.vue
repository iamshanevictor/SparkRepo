    ...
    <div class="upload-form">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          ...
          />
          <small id="project-url-help">Please enter the shareable URL of your Canva project</small>
          <div
...
export default {
  ...
  computed: {
    ...
    urlError() {
      ...
      if (!this.isValidUrl) return 'Needs a valid Canva link (https://www.canva.com/design/...).'
      return ''
    }
  },
  methods: {
